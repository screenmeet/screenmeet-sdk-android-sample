...
class MoreBottomSheet : BottomSheetDialogFragment() {
    ...
    private fun provideActions(): List<MoreActionItem> {
        ...
        } else MoreActionItem(R.string.share_cam_front, R.drawable.ic_video_camera_front)
        ...
        } else MoreActionItem(R.string.share_cam_back, R.drawable.ic_video_camera_back)
        ...
        } else MoreActionItem(R.string.share_screen, R.drawable.screen_share)
        ...
        } else MoreActionItem(R.string.share_audio, R.drawable.mic)
        items.add(audioItem)
        ...
        val viewConfidentiality = MoreActionItem(R.string.view_confidentiality, R.drawable.ic_security)
        items.add(viewConfidentiality)

        val webConfidentiality  = MoreActionItem(R.string.web_confidentiality, R.drawable.ic_web_stories)
