...
import com.screenmeet.sdkdemo.databinding.FragmentConnectBinding
...
class ConnectFragment: Fragment(R.layout.fragment_connect) {
    ...
    private fun connect(code: String){
        ...
        ScreenMeet.connect(code, object : CompletionHandler {
            override fun onSuccess() { connectionSuccess() }
            override fun onFailure(error: CompletionError) { connectionError(error) }
        })
    }
    ...
    private fun showCaptchaDialog(challenge: Challenge) {
        ...
        AlertDialog.Builder(context).apply {
            ...
            view.findViewById<ImageView>(R.id.captchaImage).setImageBitmap(challenge.challenge)
    ...
    private fun showError(message: String){
        ...
        binding.resultTv.isVisible = true
        binding.resultTv.setTextColor(ContextCompat.getColor(binding.root.context, R.color.bright_red))
