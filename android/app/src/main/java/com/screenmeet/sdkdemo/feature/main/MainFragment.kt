...
import com.screenmeet.sdkdemo.databinding.FragmentMainBinding
...
class MainFragment: Fragment(R.layout.fragment_main) {
    ...
    private fun features(): List<Pair<String, Int>> {
        ...
        react()?.let { features.add(Pair("React Native Activity Demo", -1)) }
        flutter()?.let { features.add(Pair("Flutter Activity Demo", -1)) }
