...
import com.screenmeet.sdkdemo.databinding.LayoutParticipantBinding;
...
public class ParticipantsAdapter extends RecyclerView.Adapter<ParticipantsAdapter.ViewHolder> {
    ...
    private final EglBase.Context eglBase;

    private String activeParticipantId = "";
    private int recyclerSize = 0;

    public ParticipantsAdapter(ArrayList<Participant> participants, EglBase.Context eglBase) {
